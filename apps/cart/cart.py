...
class Cart:
    '''
    📦 El carrito vive en la sesión
    🧠 Si no existe → se crea
    🔄 Siempre tenés self.cart disponible
    ...
    def __init__(self, request):
        ...
        self.cart = cart
        # Cupón aplicado actual de la tienda:
    ...
    def clear(self):
        ...
        self.session.pop('coupon_id', None)  # 👈 elimina el cupón si existe
        self.session.modified = True
